  ...
  return (
    <div className="gap-12 px-4 pb-3 w-[60rem]">
      ...
      {section === "Hero" && (
        ...
        <div className="w-full h-full pb-3 border border-gray-300 shadow-md px-3 gap-2 rounded-lg">
      ...
      {section === "Experience" && (
          <div className=" text-sm mt-3 w-full">
            ...
            <div className="w-full h-full pb-3 border border-gray-300 shadow-md px-3 pb-3 gap-2 rounded-lg">
              <p className="p-3 bg-red-100 -mx-3 text-md">
                Section: Experience{" "}
